# Operator only supported for dbt Cloud. Since we are running in local, we will use custom Operator
...
class DbtCoreOperator(BaseOperator):
    ...
    def execute(self, context):
        ...
        self.log.info("Executing dbt commandd: %s", " ".join(command_args))
